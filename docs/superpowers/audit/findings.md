...
### B2 — Plasmo scaffold produces a non-installable project (upstream)
...
### M1 — `wxt@latest` floating in the interactive scaffold docs
...
### M3 — `wxt init --template` minimum version undocumented
